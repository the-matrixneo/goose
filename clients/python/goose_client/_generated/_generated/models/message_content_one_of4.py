...
class MessageContentOneOf4(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["arguments", "id", "prompt", "toolName", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['toolConfirmationRequest']):
            raise ValueError("must be one of enum values ('toolConfirmationRequest')")
        return value

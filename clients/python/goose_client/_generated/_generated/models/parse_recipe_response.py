...
class ParseRecipeResponse(BaseModel):
    ...
    """ # noqa: E501
    recipe: Recipe
    __properties: ClassVar[List[str]] = ["recipe"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ParseRecipeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParseRecipeResponse from a dict"""
        if obj is None:
            return None

...
class ExtensionConfigOneOf3(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["available_tools", "bundled", "description", "name", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['platform']):
            raise ValueError("must be one of enum values ('platform')")
        return value

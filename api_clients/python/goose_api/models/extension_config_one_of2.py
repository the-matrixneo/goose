...
class ExtensionConfigOneOf2(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["available_tools", "bundled", "description", "display_name", "name", "timeout", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['builtin']):
            raise ValueError("must be one of enum values ('builtin')")
        return value

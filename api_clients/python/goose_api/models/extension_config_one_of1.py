...
class ExtensionConfigOneOf1(BaseModel):
    """
    ...
    env_keys: Optional[List[StrictStr]] = None
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["args", "available_tools", "bundled", "cmd", "description", "env_keys", "envs", "name", "timeout", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['stdio']):
            raise ValueError("must be one of enum values ('stdio')")
        return value

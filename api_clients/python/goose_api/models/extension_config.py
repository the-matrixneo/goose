...
EXTENSIONCONFIG_ONE_OF_SCHEMAS = ["ExtensionConfigOneOf", "ExtensionConfigOneOf1", "ExtensionConfigOneOf2", "ExtensionConfigOneOf3", "ExtensionConfigOneOf4", "ExtensionConfigOneOf5"]
...
class ExtensionConfig(BaseModel):
    ...
    actual_instance: Optional[Union[ExtensionConfigOneOf, ExtensionConfigOneOf1, ExtensionConfigOneOf2, ExtensionConfigOneOf3, ExtensionConfigOneOf4, ExtensionConfigOneOf5]] = None
    one_of_schemas: Set[str] = { "ExtensionConfigOneOf", "ExtensionConfigOneOf1", "ExtensionConfigOneOf2", "ExtensionConfigOneOf3", "ExtensionConfigOneOf4", "ExtensionConfigOneOf5" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ExtensionConfig with oneOf schemas: ExtensionConfigOneOf, ExtensionConfigOneOf1, ExtensionConfigOneOf2, ExtensionConfigOneOf3, ExtensionConfigOneOf4, ExtensionConfigOneOf5. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ExtensionConfig with oneOf schemas: ExtensionConfigOneOf, ExtensionConfigOneOf1, ExtensionConfigOneOf2, ExtensionConfigOneOf3, ExtensionConfigOneOf4, ExtensionConfigOneOf5. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ExtensionConfig with oneOf schemas: ExtensionConfigOneOf, ExtensionConfigOneOf1, ExtensionConfigOneOf2, ExtensionConfigOneOf3, ExtensionConfigOneOf4, ExtensionConfigOneOf5. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ExtensionConfig with oneOf schemas: ExtensionConfigOneOf, ExtensionConfigOneOf1, ExtensionConfigOneOf2, ExtensionConfigOneOf3, ExtensionConfigOneOf4, ExtensionConfigOneOf5. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ExtensionConfigOneOf, ExtensionConfigOneOf1, ExtensionConfigOneOf2, ExtensionConfigOneOf3, ExtensionConfigOneOf4, ExtensionConfigOneOf5]]:

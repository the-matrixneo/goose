...
class MessageContentOneOf3(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["id", "toolResult", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['toolResponse']):
            raise ValueError("must be one of enum values ('toolResponse')")
        return value

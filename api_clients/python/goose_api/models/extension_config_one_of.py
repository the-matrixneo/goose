...
class ExtensionConfigOneOf(BaseModel):
    """
    ...
    type: StrictStr
    uri: StrictStr
    __properties: ClassVar[List[str]] = ["available_tools", "bundled", "description", "env_keys", "envs", "name", "timeout", "type", "uri"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sse']):
            raise ValueError("must be one of enum values ('sse')")
        return value

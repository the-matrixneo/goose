...
export const executeTool = <ThrowOnError extends boolean = false>(options: Options<ExecuteToolData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ExecuteToolResponse2, unknown, ThrowOnError>({

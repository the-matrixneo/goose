...
export const archiveRecipe = <ThrowOnError extends boolean = false>(options: Options<ArchiveRecipeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ArchiveRecipeResponses, ArchiveRecipeErrors, ThrowOnError>({
        url: '/recipes/archive',
        ...options,
        headers: {
            'Content-Type': 'application/json',

 ...
 */
export const getEffectiveConfig = <ThrowOnError extends boolean = false>(options?: Options<GetEffectiveConfigData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetEffectiveConfigResponses, GetEffectiveConfigErrors, ThrowOnError>({

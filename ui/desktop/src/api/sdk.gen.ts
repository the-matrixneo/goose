...
export const greetingStream = <ThrowOnError extends boolean = false>(options: Options<GreetingStreamData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GreetingStreamResponses, GreetingStreamErrors, ThrowOnError>({
        url: '/greeting',
        ...options
    });
};

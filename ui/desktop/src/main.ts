...
ipcMain.handle('create-floating-button', async (event, data) => {
  ...
  try {
    ...
    const floatingWindow = new BrowserWindow({
      width: size === 'large' ? 96 : size === 'medium' ? 80 : 64,
      height: size === 'large' ? 96 : size === 'medium' ? 80 : 64,
      x: Math.round(x),
      y: Math.round(y),
      frame: false,
      transparent: true,
      ...
      <style>
        * {
        ...
        .floating-button {
          ...
          box-shadow: 0px 2px 4px 0px rgba(255, 255, 255, 0.8) inset, 
                      0px 8px 16px 0px rgba(255, 255, 255, 0.3) inset, 
                      -2px 2px 8px 0px rgba(255, 255, 255, 0.4) inset, 
        ...
        .floating-button:hover {
          ...
          box-shadow: 0px 2px 4px 0px rgba(255, 255, 255, 0.9) inset, 
                      0px 8px 16px 0px rgba(255, 255, 255, 0.4) inset, 
                      -2px 2px 8px 0px rgba(255, 255, 255, 0.5) inset, 
    ...
    floatingWindow.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(floatingButtonHTML)}`);

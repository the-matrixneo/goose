  ...
  return (
    <section id="appSettings">
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-xl text-text-default">App Settings</h2>
      </div>
      <div className="pb-8">
        <p className="text-sm text-text-muted mb-6">Configure Goose app</p>
        <div>
          {/* Task Notifications */}
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-text-default">Notifications</h3>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-text-default">Menu Bar Icon</h3>
              <p className="text-xs text-text-muted max-w-md mt-[2px]">
          ...
          {isMacOS && (
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-text-default">Dock Icon</h3>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-text-default">Quit Confirmation</h3>
              <p className="text-xs text-text-muted max-w-md mt-[2px]">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <h3 className="text-lg text-text-default mb-1">Help & Feedback</h3>
        ...
        {/* Update Section */}
        {UPDATES_ENABLED && (
          <div ref={updateSectionRef} className="mt-8 pt-8 border-t border-border-default">
            <UpdateSection />
          </div>
        )}
      </div>

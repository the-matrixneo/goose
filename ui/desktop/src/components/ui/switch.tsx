  ...
  <SwitchPrimitives.Root
    className={cn(
      ...
      variant === 'default'
        ...
        : 'data-[state=checked]:bg-black dark:data-[state=checked]:bg-white data-[state=unchecked]:bg-background-default dark:data-[state=unchecked]:bg-[#333333]',
      className
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        variant === 'default'
          ? 'bg-background-default data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0'

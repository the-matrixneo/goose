  ...
  <SwitchPrimitives.Root
    className={cn(
      ...
      variant === 'default'
        ...
        : 'data-[state=checked]:bg-slate-900 dark:data-[state=checked]:bg-white data-[state=unchecked]:bg-slate-300 dark:data-[state=unchecked]:bg-[#333333]',
      className
    )}
    {...props}
    ref={ref}
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        variant === 'default'
          ...
          : 'bg-white dark:bg-black data-[state=checked]:translate-x-3 data-[state=unchecked]:translate-x-0'
      )}
    />
  </SwitchPrimitives.Root>
));

        ...
        <div className="flex flex-col group">
          <div className="flex bg-background-accent text-text-on-accent rounded-2xl py-2 px-4">
            <div ref={contentRef}>
              <MarkdownContent
                content={displayText}
                className="text-text-on-accent prose-a:text-text-on-accent user-message"
              />
            </div>
          </div>
          ...
          <div className="relative h-[22px] flex justify-end">
            <div className="absolute left-0 w-40 text-xs text-text-muted pt-1 transition-all duration-200 group-hover:-translate-y-4 group-hover:opacity-0">
              {timestamp}
            </div>
